<?php
	...
	use SMSGatewayCenterPhpSdk\config\sgc_user_password_api_params;
	...
	class sgc_password {
		...
		function Change() {
			...
			$response = new sgc_callapi(sgc_constant::SGC_LIB_API, sgc_constant::SGC_ENDPOINT_PASSWORD_CHANGE, $this->data, $this->header, sgc_common_api_params::API_COMMON_METHOD_POST, $this->useRestApi);
