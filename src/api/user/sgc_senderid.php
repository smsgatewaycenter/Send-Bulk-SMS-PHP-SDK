<?php
	...
	use SMSGatewayCenterPhpSdk\config\sgc_user_senderId_api_params;
	...
	class sgc_senderid {
		...
		function create() {
			$this->data['do'] = 'add';
			$this->data[sgc_user_senderId_api_params::API_USER_SENDER_ID_PARAM_NEW_SENDER_ID] = $this->user->getNewSenderId();
			$response = new sgc_callapi(sgc_constant::SGC_LIB_API, sgc_constant::SGC_ENDPOINT_SENDER_ID, $this->data, $this->header, sgc_common_api_params::API_COMMON_METHOD_POST, $this->useRestApi);
		...
		function read() {
			$this->data['do'] = 'list';
			$response = new sgc_callapi(sgc_constant::SGC_LIB_API, sgc_constant::SGC_ENDPOINT_SENDER_ID, $this->data, $this->header, sgc_common_api_params::API_COMMON_METHOD_GET, $this->useRestApi);
			return $response->getResponse();
		}
		...
		function update() {
			$this->data['do'] = 'edit';
			$this->data[sgc_user_senderId_api_params::API_USER_SENDER_ID_PARAM_NEW_SENDER_ID] = $this->user->getNewSenderId();
			$this->data[sgc_user_senderId_api_params::API_USER_SENDER_ID_PARAM_UPDATE_SENDER_ID] = $this->user->getOldSenderId();
			$response = new sgc_callapi(sgc_constant::SGC_LIB_API, sgc_constant::SGC_ENDPOINT_SENDER_ID, $this->data, $this->header, sgc_common_api_params::API_COMMON_METHOD_POST, $this->useRestApi);
			return $response->getResponse();
		}
		...
		function delete() {
			$this->data['do'] = 'delete';
			$this->data[sgc_user_senderId_api_params::API_USER_SENDER_ID_PARAM_DELETE_SENDER_ID] = $this->user->getDelSenderId();
